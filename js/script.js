...
const terminalThoughts = [
    "Lina is very excited to talk with you!",
    "Lina is reflecting on your message.",
    "Lina is wondering what to say next.",
    "Lina is processing emotions...",
    "Lina feels like this is a great conversation!"
];
